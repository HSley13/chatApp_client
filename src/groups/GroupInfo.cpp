...
GroupInfo::GroupInfo(const int &group_ID, const int &group_admin, const QString &group_name, const QList<ContactInfo *> &group_members, const QString &group_image_url, const int &group_unread_message, QObject *parent)
    : QObject(parent),
      ...
      _group_name(group_name), _group_members(group_members),
...
const QString &GroupInfo::group_name() const { return _group_name; }
...
QList<ContactInfo *> &GroupInfo::group_members() { return _group_members; }
...
const QString &GroupInfo::group_image_url() const { return _group_image_url; }
...
const int &GroupInfo::group_ID() const { return _group_ID; }
...
const int &GroupInfo::group_admin() const { return _group_admin; }
...
QString GroupInfo::last_message_time() const { return _last_message_time; }
...
QString GroupInfo::message_time() const { return _message_time; }
...
const QString &GroupInfo::group_is_typing() const { return _group_is_typing; }
